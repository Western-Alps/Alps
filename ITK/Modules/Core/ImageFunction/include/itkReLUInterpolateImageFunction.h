 ...
 *
 *=========================================================================*/
#ifndef itkReLUInterpolateImageFunction_h
#define itkReLUInterpolateImageFunction_h
...
namespace itk
{
/** \class ReLUInterpolateImageFunction
 * \brief Maxpooling interpolation of an image at specified positions.
 *
 * ReLUInterpolateImageFunction interpolates image intensity at
 ...
 *
 * \sa VectorReLUInterpolateImageFunction
 *
 * \ingroup ImageFunctions ImageInterpolators
 * \ingroup ITKImageFunction
 *
 * \wiki
 * \wikiexample{ImageProcessing/ReLUInterpolateImageFunction, interpolate a position in an image}
 * \endwiki
 */
template< typename TInputImage, typename TCoordRep = double >
class ReLUInterpolateImageFunction:
  //class ITK_TEMPLATE_EXPORT ReLUInterpolateImageFunction:
  public InterpolateImageFunction< TInputImage, TCoordRep >
{
public:
  /** Standard class typedefs. */
  typedef ReLUInterpolateImageFunction                       Self;
  typedef InterpolateImageFunction< TInputImage, TCoordRep > Superclass;
  typedef SmartPointer< Self >                               Pointer;
  typedef SmartPointer< const Self >                         ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro(ReLUInterpolateImageFunction, InterpolateImageFunction);
...
protected:
  ReLUInterpolateImageFunction();
  ~ReLUInterpolateImageFunction();
  void PrintSelf(std::ostream & os, Indent indent) const ITK_OVERRIDE;

private:
//ITK_DISALLOW_COPY_AND_ASSIGN(ReLUInterpolateImageFunction);
...
#include "itkReLUInterpolateImageFunction.hxx"
#endif
