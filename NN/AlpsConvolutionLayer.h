...
namespace Alps
{
			   ...
			   public Alps::Mountain
  {
    //
    //
    using Self = ConvolutionLayer< ActivationFunction, Weights, CostFunction, Dim >;
    //
    // 
  public:
    /** Constructor. */
    explicit ConvolutionLayer( const std::string,
  ...
  ConvolutionLayer< AF, W, C, D >::ConvolutionLayer( const std::string              Layer_name,
  ...
  ConvolutionLayer< AF, W, C, D >::add_layer( std::shared_ptr< Alps::Layer > Layer )
  {
    try
      {
	if ( Layer )
  ...
  //
  template< typename AF, typename W, typename C, int D > void
  ConvolutionLayer< AF, W, C, D >::forward( std::shared_ptr< Alps::Climber > Sub )
  {
    try
      {
	//
  ...
  //
  template< typename AF, typename W, typename C, int D > void
  ConvolutionLayer< AF, W, C, D >::backward( std::shared_ptr< Alps::Climber > Sub )
  {
    try
      {
	//
  ...
  //
  template< typename AF, typename W, typename C, int D > void
  ConvolutionLayer< AF, W, C, D >::weight_update( std::shared_ptr< Alps::Climber > Sub )
  {
    try
      {
	//
