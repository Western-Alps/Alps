...
//		   const MAC::small_arrays_tmp To_cuda /*int* Half_window, int* Image_size*/,
...
//
__host__ void
MAC::Convolutional_CUDA::init( const int*    Image_size,
  ...
  if ( !CUDA_init_ )
    {
      //
      // Initialization
      std::cout << "CUDA Convolutional_CUDA init." << std::endl;
      //
...
//
__host__ void
MAC::Convolutional_CUDA::load_previouse_feature_maps( double** Prev,
							    Mapping* Map,
...
//
__host__ void
MAC::Convolutional_CUDA::convolution( Neurons_type& Sub, const int Mod,
...
//
__host__ void
MAC::Convolutional_CUDA::convolution_decoding( Neurons_type& Sub, double& E_i, const int Mod,
						     const Functions& Activation_func )
{
}
//
...
//
__host__ void
MAC::Convolutional_CUDA::transpose_weight_matrices()
{
}
//
//
