...
Alps::Mont_Maudit_builder::Mont_Maudit_builder()
{
  ...
  std::vector< long int > h_window_1 = {2,2,3}; // size of the 1/2 window
  std::vector< long int > padding_1  = {1,2,3}; // padding
  std::vector< long int > striding_1 = {1,1,1}; // striding
  //
  ...
  std::vector< long int > h_window_2 = {0,0,0}; // size of the 1/2 window, when the value is 0, the kernel is the size of a pixel
  std::vector< long int > padding_2  = {0,0,0}; // padding
  std::vector< long int > striding_2 = {1,1,1}; // striding
  //
  ...
  // layer 3
  // Window definition for the kernels. This window is centered on one voxel.
  std::vector< long int > h_window_3 = {4,4,4}; // size of the 1/2 window
  std::vector< long int > padding_3  = {0,0,0}; // padding
  std::vector< long int > striding_3 = {1,1,1}; // striding
  //
